...
echo '======='
echo '======= Subtask A WARNING: Running the format checker with some missing/skipper line_numbers.'
python3 subtaskA.py --pred_file_path=${format_checker_tests_path}subtaskA_WARN_MISSING_ID.txt
echo '======='
echo '======= Subtask A NOT OK: Running the format checker where line_numbers are separated with commas, not with new lines.'
